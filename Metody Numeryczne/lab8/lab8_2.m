...
S = [ -0.5,   1;                 % zmiana wartości z lew.gór rogu i dol.praw.rogu wpływa na zwiększenie rozmiaru okręgu
     1,   0.5 ];                % oraz zmniejsza nachylenie
...
function x = elipsa(S,r,N)
    [V,D] = eig(S);                    % to takie sciaganie do macierzy
