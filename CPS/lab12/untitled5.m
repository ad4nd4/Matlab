...
% Low Pass filter (LP)
lp_window = hamming(32) * hamming(32)';
lp_filter = fwind1(fspecial('average', 32), lp_window);

% High Pass filter (HP)
hp_operator = fspecial('sobel');
hp_filter = fwind1(hp_operator, lp_window);
...
lp_filter_16 = fwind1(fspecial('average', 16), hamming(16) * hamming(16)');
